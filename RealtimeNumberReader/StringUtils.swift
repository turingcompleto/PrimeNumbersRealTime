...
extension String {
	...
	func extractPrimeNumber() -> (Range<String.Index>, String)? {
		let pattern = #"""
		...
		// Potential number found. Strip out punctuation, whitespace
        ...
        //Prime numbers logic
        let prime = Int(result) ?? 0
        var flag = 1
        
        for i in stride(from: 2, to: prime, by: 1){
